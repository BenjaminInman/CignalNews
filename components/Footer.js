    ...
    <footer className="site-footer">
      <div className="wrap">
        <div className="foot-top">
          <div>
            <div className="mark">CIGNAL</div>
            <p>
              Cignal aggregates US economic headlines from primary sources and major
              publishers, organized by where each theme sits in the market cycle. Every
              headline links to its original source.
            </p>
          </div>
        ...
        <div className="foot-bottom">
          <span>© {new Date().getFullYear()} Cignal</span>
