...
Output ONLY a JSON array of objects with keys: indicator, label, category, cycle_class, value, value_text, unit, geography, period, direction, confidence. No prose, no markdown, no code fences. Empty array if nothing qualifies.`;
